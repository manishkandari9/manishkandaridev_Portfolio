...
export const portfolioData: PortfolioData = {
  ...
  skills: {
    ...
    skills: [
      ...
      { id: "typescript", name: "TypeScript", level: 1, category: "frontend" },
      ...
      { id: "firebase", name: "Firebase", level: 2, category: "backend" },
      ...
      { id: "docker", name: "Docker", level: 1, category: "tools" },
      { id: "aws", name: "AWS", level: 0, category: "tools" },
      { id: "cicd", name: "CI/CD", level: 65, category: "tools" },
      { id: "communication", name: "Communication", level: 85, category: "soft" },
      { id: "problem-solving", name: "Problem Solving", level: 25, category: "soft" },
